                  ...
                  <div className="pt-4">
                    ...
                    <div className="mt-5 flex justify-between items-center">
                      <span className="flex items-center">
                        ...
                        <Link
                          to=""
                          className="ms-1 text-slate-400 hover:text-amber-400"
                        >
                          {item.author}
                        </Link>
                      </span>
              ...
              <nav aria-label="Page navigation example">
                <ul className="inline-flex items-center -space-x-px">
                  <li>
                    <Link
                      to="#"
                      className="w-9 h-9 inline-flex text-sm justify-center items-center text-slate-400 bg-white dark:bg-slate-900 rounded-s-3xl hover:text-white border border-gray-100 dark:border-gray-800 hover:border-amber-400 dark:hover:border-amber-400 hover:bg-amber-400 dark:hover:bg-amber-400"
                    >
                  ...
                  <li>
                    <Link
                      to="#"
                      className="w-9 h-9 inline-flex text-sm justify-center items-center text-slate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:border-amber-400 dark:hover:border-amber-400 hover:bg-amber-400 dark:hover:bg-amber-400"
                    >
                      1
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      to="#"
                      aria-current="page"
                      className="z-10 w-9 h-9 inline-flex text-sm justify-center items-center text-white bg-amber-400 border border-amber-400"
                    >
                      3
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      to="#"
                      className="w-9 h-9 inline-flex text-sm justify-center items-center text-slate-400 bg-white dark:bg-slate-900 rounded-e-3xl hover:text-white border border-gray-100 dark:border-gray-800 hover:border-amber-400 dark:hover:border-amber-400 hover:bg-amber-400 dark:hover:bg-amber-400"
                    >

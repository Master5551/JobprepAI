                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center mt-6">
                        ...
                        <ul className="tracking-[0.5px] mb-0 inline-block mt-5">
                            <li className="inline-block capitalize text-[15px] font-medium duration-500 ease-in-out text-white/50 hover:text-white"><Link to="/">JobPrepAI</Link></li>
            ...
            <section className="relative md:pb-24 pb-16">
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-6 text-center">
                        ...
                        <p className="text-slate-400 max-w-xl mx-auto">JobPrepAI: Elevate your interview game with mock interviews and personalized feedback. Ace your career goals effortlessly.</p>
                    </div>
                    <Pricing />
                </div>
                <ClientsTwo />
